...
- [**Modern UI (Qt)**](https://github.com/abulhawa/dupliclean/releases/latest/download/dupliclean-modern-v1.1.1.zip)
- [**Legacy UI (Tk)**](https://github.com/abulhawa/dupliclean/releases/latest/download/dupliclean-legacy-v1.1.1.zip)
